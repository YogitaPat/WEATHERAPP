...
//
const lblEmail = "Please Enter your Email address";
const lblPass = "Please Enter you Password";
const lblLogin = "Login";


final snackBar = SnackBar(
  content: const Text('Please Enter EmailId'),
